...
<!--                    <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>-->
            ...
            <div class="col-lg-2 col-xs-6">
                ...
                <div class="small-box bg-green">
					...
					<a href="<?php echo base_url();?>logins" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-2 col-xs-6">
			...
			<div class="col-lg-2 col-xs-6">
				...
				<div class="small-box bg-teal">
					...
					<a href="<?php echo base_url();?>attempted_payments" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
            <!-- ./col -->
        </div>
